...
public class GroceryListJdbcTemplateRepository implements GroceryListRepository{
    ...
    public List<GroceryList> findAll() {
        final String sql = "select id grocery_list_id, user_app_user_id, name grocery_list_name "
                + "from grocery_list;";
    ...
    private void addIngredients(GroceryList groceryList){
        final String sql = "select i.id ingredient_id, i.name ingredient_name, i.aisle, i.image_url " +
                "from ingredient i " +
