...
BEGIN
	...
	INSERT INTO `recipe` (`id`, `user_app_user_id`, `title`, `image_url`, `image`, `instructions`, `vegetarian`, `vegan`, `gluten_free`, `dairy_free`, `servings`, `src_url`, `cook_minutes`)
		VALUES
		(1, 2, 'Pepper Pizza', 'https://spoonacular.com/recipeImages/Fresh-Veggie-Pizza-394118.jpg', null, 'Mix ingredients together and throw in the oven at 400 for 20 minutes', 1, 0, 0, 0, 4, 'https://recipes.com/pepper-pizza', 45),
